...
const useSocketConnection = () => {
  ...
  const {
    ...
    useShallow((state) => ({
      ...
      updateGroupData: state.updateGroupData,
    })),
  );
  const {
    friendsList,
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      chatSocket.off("groupDataUpdated", onGroupDataUpdated);
